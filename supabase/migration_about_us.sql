-- Crear tabla about_us para contenido dinámico de la sección About Us
...
-- Asegurar que solo exista un registro (opcional pero recomendado)
CREATE UNIQUE INDEX single_about_us_record ON about_us ((1));
