...
export const Gallery = async () => {
  ...
  return (
    <section
      className="relative py-6 sm:py-8 md:py-16 px-4 sm:px-8 md:px-[96px]"
      style={{ backgroundColor: '#000000', backgroundImage: 'linear-gradient(rgba(255,255,220,0.07) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,220,0.07) 1px, transparent 1px)', backgroundSize: '48px 48px' }}
    >
